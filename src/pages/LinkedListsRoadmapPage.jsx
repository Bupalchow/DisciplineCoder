/**
 * Linked Lists Roadmap Page
 * Specific page for the Linked Lists learning roadmap
 */
...
/**
 * LinkedListsRoadmapPage component
 * Displays the complete Linked Lists roadmap interface
 */
const LinkedListsRoadmapPage = () => {
  const {
    progress,
    isLoading,
    ...
    resetProgress,
    getProgressStats
  } = useRoadmapProgress(LINKED_LISTS_ROADMAP.id);

  const [showResetConfirm, setShowResetConfirm] = useState(false);
  const progressStats = getProgressStats(LINKED_LISTS_ROADMAP);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center space-x-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">{LINKED_LISTS_ROADMAP.title}</h1>
              <p className="text-gray-600 mt-1">{LINKED_LISTS_ROADMAP.description}</p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center space-x-8 text-sm text-gray-600">
            <div className="flex items-center space-x-2">
              ...
              <span>{LINKED_LISTS_ROADMAP.estimatedTime}</span>
            </div>
            <div className="flex items-center space-x-2">
              <BookOpenIcon className="h-4 w-4" />
              <span>{LINKED_LISTS_ROADMAP.totalQuestions} Questions</span>
            </div>
          </div>
        </div>
        ...
        {/* Roadmap Container */}
        <RoadmapContainer
          roadmapData={LINKED_LISTS_ROADMAP}
          progress={progress}
...
export default LinkedListsRoadmapPage;
