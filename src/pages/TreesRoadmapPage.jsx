/**
 * Trees Roadmap Page
 * Specific page for the Trees learning roadmap
 */
...
/**
 * TreesRoadmapPage component
 * Displays the complete Trees roadmap interface
 */
const TreesRoadmapPage = () => {
  const {
    progress,
    isLoading,
    ...
    resetProgress,
    getProgressStats
  } = useRoadmapProgress(TREES_ROADMAP.id);

  const [showResetConfirm, setShowResetConfirm] = useState(false);
  const progressStats = getProgressStats(TREES_ROADMAP);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center space-x-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">{TREES_ROADMAP.title}</h1>
              <p className="text-gray-600 mt-1">{TREES_ROADMAP.description}</p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center space-x-8 text-sm text-gray-600">
            <div className="flex items-center space-x-2">
              ...
              <span>{TREES_ROADMAP.estimatedTime}</span>
            </div>
            <div className="flex items-center space-x-2">
              <BookOpenIcon className="h-4 w-4" />
              <span>{TREES_ROADMAP.totalQuestions} Questions</span>
            </div>
          </div>
        </div>
...
export default TreesRoadmapPage;
